...
:::tip
Remember to [URL-encode](https://urlencoder.io) the `text` parameter. Otherwise special characters and symbols might not be included correctly (the [QR builder](https://quickchart.io/qr-code-api/) takes care of this automatically).
:::
...
Use our [interactive QR code generator](https://quickchart.io/qr-code-api/) to preview API behavior and test things out. You may also be interested in how to [generate QR codes in a spreadsheet](TODO).
