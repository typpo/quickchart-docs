...
sidebar_position: 20
sidebar_label: Adding a watermark
---
...
<ChartExample
  alt="A chart with a background image"
  noLazyLoad
  showEditor
  config={`{
  type: 'bar',
