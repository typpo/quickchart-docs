...
The table API endpoint is available at `https://quickchart.io/v1/table`. The `https://api.quickchart.io/v1/table` URL also works. It takes a `data` parameter that defines the columns and rows of the table. Here's an example `data` parameter:
...
<CodeWithHighlights wrap code={`**https://quickchart.io/v1/table?data**={"title":"My table","columns":[{"title":"Column 1","dataIndex":"col1"},{"title":"Column 2","dataIndex":"col2"}],"dataSource":[{"col1":"Foo","col2":12},{"col1":"Foo","col2":12}]}`}/>

This creates the following image:

<Image src="https://quickchart.io/v1/table?data={%22title%22:%22My%20table%22,%22columns%22:[{%22title%22:%22Column%201%22,%22dataIndex%22:%22col1%22},{%22title%22:%22Column%202%22,%22dataIndex%22:%22col2%22}],%22dataSource%22:[{%22col1%22:%22Foo%22,%22col2%22:12},{%22col1%22:%22Foo%22,%22col2%22:12}]}"/>
...
<CodeWithHighlights wrap code={`**https://quickchart.io/v1/table?data**={"title":"Marketing Summary","columns":[{"width":200,"title":"Campaign","dataIndex":"campaign"},{"width":100,"title":"Install","dataIndex":"install","align":"right"},{"width":100,"title":"Cost","dataIndex":"cost","align":"right"}],"dataSource":["-",{"campaign":"Google CPC","install":"12","cost":"$ 400"},{"campaign":"Facebook CPC","install":"3","cost":"$ 60"},{"campaign":"Youtube Video","install":"131","cost":"$ 1,230"},"-",{"campaign":"Total","install":"146","cost":"$ 1,690"}]}`} />

This is the generated PNG image:

<Image src="https://quickchart.io/v1/table?data={%22title%22:%22Marketing%20Summary%22,%22columns%22:[{%22width%22:200,%22title%22:%22Campaign%22,%22dataIndex%22:%22campaign%22},{%22width%22:100,%22title%22:%22Install%22,%22dataIndex%22:%22install%22,%22align%22:%22right%22},{%22width%22:100,%22title%22:%22Cost%22,%22dataIndex%22:%22cost%22,%22align%22:%22right%22}],%22dataSource%22:[%22-%22,{%22campaign%22:%22Google%20CPC%22,%22install%22:%2212%22,%22cost%22:%22$%20400%22},{%22campaign%22:%22Facebook%20CPC%22,%22install%22:%223%22,%22cost%22:%22$%2060%22},{%22campaign%22:%22Youtube%20Video%22,%22install%22:%22131%22,%22cost%22:%22$%201,230%22},%22-%22,{%22campaign%22:%22Total%22,%22install%22:%22146%22,%22cost%22:%22$%201,690%22}]}"/>
...
| offsetTop         | number | Default text offset from top border of table cell  | 26            |
...
All the examples so far are `GET` requests, but you can `POST` the `https://quickchart.io/v1/table` endpoint too. Here's an example payload with content-type `application/json`:
...
```bash
curl -X POST -H 'content-type: application/json' -d @table.json -o table.png https://quickchart.io/v1/table
```

## Errors

A missing `data` parameter or invalid JSON in `data` or `options` returns HTTP 400. The response is a PNG containing the error, with the message also available in the `X-quickchart-error` header. See [error handling](/documentation/usage/handling-errors/).
