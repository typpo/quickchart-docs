...
To disable retina support set the `devicePixelRatio` parameter to 1.0 (see [query parameters documentation](TODO)). `devicePixelRatio` acts as a multiplier on the width and height of your chart.
