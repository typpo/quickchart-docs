...
The chart legend can be customized via the `options.legend` property ([more information on chart legend](https://www.chartjs.org/docs/2.9.4/configuration/legend.html)).
