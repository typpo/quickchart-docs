...
To **color the chart background**, set the `backgroundColor` query parameter to fill the entire chart background. See [API parameters](/documentation/usage/parameters/).
...
To customize **font and label colors**, see [font customization](/documentation/reference/fonts/).

## Gridlines and axes colors

To customize **gridline and axis colors**, reference [gridlines documentation](/documentation/reference/grid-lines/).
