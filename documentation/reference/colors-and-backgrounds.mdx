...
To **color the chart background**, set the `backgroundColor` query parameter to fill the entire chart background. See [API parameters](/documentation/using-the-api/parameters/).
